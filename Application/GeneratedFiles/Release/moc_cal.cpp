...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_cal_t, stringdata) + ofs \
...
const QMetaObject cal::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cal.data,
      qt_meta_data_cal,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cal.stringdata))
        return static_cast<void*>(const_cast< cal*>(this));
    if (!strcmp(_clname, "IModule"))
        return static_cast< IModule*>(const_cast< cal*>(this));
