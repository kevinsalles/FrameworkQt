...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Slider_t, stringdata) + ofs \
...
void Slider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Slider::*_t)(const int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Slider::valueChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Slider::valueChanged(const int _t1)
{
